...
cfg.bfm_tex_space_path = os.path.join(cfg.root_dir, 'model', 'BFM_texture.npz')
cfg.balanced_albedo_tex_space_path = os.path.join(cfg.root_dir, 'model', 'TRUST_texture.npz')
cfg.flame_model_path = os.path.join(cfg.root_dir, 'model', 'generic_model.pkl')

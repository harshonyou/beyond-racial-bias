...
from reni_plus_plus.illumination_fields.base_spherical_field import BaseRENIField, BaseRENIFieldConfig
from reni_plus_plus.field_components.siren import Siren
from reni_plus_plus.field_components.film_siren import FiLMSiren
from reni_plus_plus.field_components.activations import ExpLayer
from reni_plus_plus.field_components.transformer_decoder import Decoder
from reni_plus_plus.field_components.field_heads import RENIFieldHeadNames
from reni_plus_plus.field_components.vn_layers import VNInvariant, VNLinear

from reni_plus_plus.cameras.rays import RaySamples
from reni_plus_plus.field_components.encodings import NeRFEncoding
...
class RENIField(BaseRENIField):
    ...
    def get_outputs(
        ...
        outputs[RENIFieldHeadNames.RGB.value] = model_outputs
        outputs[RENIFieldHeadNames.MU.value] = mu
        outputs[RENIFieldHeadNames.LOG_VAR.value] = log_var
